...
describe('HomePage', () => {
  it('제안 핵심 섹션을 모두 보여준다', () => {
    ...
    expect(screen.getByText('PRD 두 버전 구조')).toBeInTheDocument();
    expect(screen.getByText('구현 계획형 PRD')).toBeInTheDocument();
    expect(screen.getByText('설계 해석형 PRD')).toBeInTheDocument();
